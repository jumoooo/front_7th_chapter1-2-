...
4. `src/__mocks__/handlers.ts` - MSW batch API
...
- Dev: MSW batch API 및 mock 데이터 설정 완료 (#STORY-002)
```
...
### 향후 개선 사항
1. **서버 API 구현**: `POST /api/events/batch` 실제 서버 구현 필요
...
3. **서버 API 구현** - batch API 실제 서버 구현 필요
